...
3. смотрим анкету, дипломную работу, спрашиваем мнение о теме и работах студентов кафедры, задаем вопросы по [математической части](https://arxiv.org/abs/2206.13446) бакалаврской программы.
...
### Вопросы на проверку базовых умений 2023  
Разделы 1, 2, 3 из [Pen and Paper Exercises in Machine Learning by Michael U. Gutmann](https://arxiv.org/abs/2206.13446)
